      ...
      <div className="container-fluid">
        <div className="d-flex align-items-center py-2">
          ...
          <div className="d-flex align-items-center d-none d-md-flex">
            <Link href="/client/reservations" className="header-icon-link" aria-label="Commande">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--primary-color)" width="24" aria-hidden="true" focusable="false">
            ...
            <Link href="/panier" className="header-icon-link" aria-label="Panier">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--primary-color)" width="24" aria-hidden="true" focusable="false">
            ...
            {user && user.role === 'client' ? (
              <Link href="/client/" className="header-icon-link" aria-label="Compte client">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--primary-color)" width="24" aria-hidden="true" focusable="false">
              ...
              <Link href="/login" className="header-icon-link" aria-label="Connexion">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--primary-color)" width="24" height="24" aria-hidden="true" focusable="false">
                  <path fillRule="evenodd" d="M14.674 14.864l7.122 1.516c1.31.334 2.204 1.529 2.204 2.895V24H0v-4.725c0-1.366.917-2.56 2.227-2.895l7.122-1.516a10.76 10.76 0 0 1 5.325 0zM12 0a6 6 0 1 1-.001 12.001A6 6 0 0 1 12 0z"></path>
                </svg>
                <small>Compte</small>
              </Link>
